...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // Base
        "flex w-fit items-center justify-between gap-2 rounded-lg bg-background px-3 py-2 text-sm",
        // Border - subtle
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Base
        "relative flex w-full cursor-default items-center gap-2 rounded-md py-2 pr-8 pl-2.5 text-sm",
        // State
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        "-mx-1.5 my-1.5 h-px bg-border/50 pointer-events-none",
        className
      )}
      {...props}
    />
