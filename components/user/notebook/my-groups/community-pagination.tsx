...
interface MyGroupsPaginationProps {
  meta: PagedMeta;
  page: number;
  onPageChange: (page: number) => void;
}

export default function MyGroupsPagination({
  meta,
  page,
  onPageChange,
}: MyGroupsPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between flex-wrap gap-4">
      <p className="text-sm text-muted-foreground">
        ...
        trong tổng số{" "}
        <span className="font-medium text-foreground">{meta.total}</span> nhóm
      </p>
