...
import { Mic, Upload, HelpCircle, CheckCircle2 } from "lucide-react";
          ...
          <CardTitle className="text-sm flex items-center gap-3 text-foreground">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="text-xs">
                    AI sẽ phân tích và tạo tóm tắt podcast của bạn
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-base font-semibold text-foreground mb-2.5">
              Chưa có podcast nào được tải lên
            </h3>
            <p className="text-sm text-muted-foreground mb-7 max-w-xs mx-auto leading-relaxed">
              Tải lên podcast để AI phân tích và tạo tóm tắt tự động
            </p>
            <Button
              variant="outline"
              size="sm"
            ...
            <div className="mt-8 pt-6 border-t border-border/40">
              ...
              <div className="space-y-2.5 text-left max-w-xs mx-auto">
                ...
                <div className="flex items-start gap-2.5 text-xs text-muted-foreground">
                  <CheckCircle2 className="size-4 mt-0.5 shrink-0 text-foreground/60" />
                  <span>Hỗ trợ MP3, audio files</span>
                </div>
              </div>
            </div>
          </div>
