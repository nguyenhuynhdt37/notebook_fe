  ...
  return (
    <div className="flex gap-3.5 max-w-4xl mr-auto animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="shrink-0">
        <Avatar className="size-9 border-2 border-primary/20 shadow-sm ring-1 ring-primary/5">
      ...
      <div className="flex flex-col gap-2 flex-1">
        <div className="rounded-2xl px-5 py-4 bg-muted/60 border border-border/50 shadow-sm inline-block backdrop-blur-sm">
